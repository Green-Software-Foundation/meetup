...
const config = {
  ...
  tagline: "Facilitating the growth of the global community of green software practitioners",
  // Change to site url
  url: "https://-meetup.greensoftware.foundation/",
  baseUrl: "/",
  onBrokenLinks: "throw",
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/Green-Software-Foundation/meetup/",
        },
        blog: false,
        theme: {
        ...
        links: [
          {
            ...
            items: [
              {
                label: "Github",
                href: "https://github.com/Green-Software-Foundation/meetup/", // Change to project repo
              },
              {
                label: "Website",
                href: "https://meetup.greensoftware.foundation",
              },
            ],
          },
          {
